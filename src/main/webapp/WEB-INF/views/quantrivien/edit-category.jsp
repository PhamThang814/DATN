				...
				<div class="form-search">
					<div class="col-12">
						<div class="card mt-5">
							...
							<div class="card-body">
								<h4 class="header-title">Cập nhật danh mục sản phẩm</h4>
								<!-- Dạng 2 :sử dụng spring-form -->
								<sf:form modelAttribute="category" class="needs-validation"
									novalidate="" action="${base }/admin/category/category-edit-save"
									method="post">
									...
									<div class="form-row">
										...
										<sf:input id="createdDate" name="createdDate" path="createdDate" type="date" cssStyle="display: none"/>
									...
									<div class="form-row">
										...
										<div class="col-md-6 mb-3">
											<label for="validationCustom03">Chi tiết danh mục</label>
											<sf:textarea path="description" type="text"
												...
												rows="3" />
											<div class="invalid-feedback">Hãy nhập chi tiết danh mục!</div>
										</div>
