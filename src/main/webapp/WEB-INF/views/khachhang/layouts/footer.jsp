	...
	<div class="introduc">
		<div class="introduc-content">
			...
			<div class="introduc-logo">
				<div>TẤT CẢ CÁC SẢN PHẨM ĐỀU ĐƯỢC THIẾT KẾ VÀ SẢN XUẤT BỞI KING SPORTS</div>
		...
		<div class="introduc-contact">
			...
			<div class="introduc-list">
				<ul>
					<li><i class="fas fa-map-marker-alt"></i> 776/47 Minh Khai
						, Q Bắc Từ Liêm, Tp Hà Nội.</li>
					<li><i class="fas fa-phone-volume"></i> 0968769276</li>
					<li><i class="fas fa-phone-volume"></i> 0382556065</li>
					<li><i class="fas fa-paper-plane"></i> kingsports2509@gmail.com
					</li>
				</ul>
			</div>
		</div>
